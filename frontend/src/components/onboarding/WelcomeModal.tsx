...
const GROUPS = [
  {
    ...
    desc: 'Оценка студенческих работ с ИСПУМ — разбор по критериям и обратная связь. Итоговое решение всегда за вами.',
  },
  {
    glyph: '▤',
  ...
  },
  {
    glyph: '▦',
    title: 'Аналитика',
    desc: 'Прогресс студентов, анализ учебного плана и постепенное обучение ИСПУМ на ваших оценках.',
  },
]
