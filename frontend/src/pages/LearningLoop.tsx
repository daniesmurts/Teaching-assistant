    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-6 space-y-6">
          <FeatureIntro
            id="learning-loop"
            title="ИИ учится у вас — посмотрите, как"
            description="Каждая ваша утверждённая оценка возвращается в систему как образец: при следующей проверке похожей работы ИИ опирается на ваши прошлые решения, а не на абстрактные стандарты. Чем больше вы проверяете, тем ближе автоматические оценки становятся к вашему стилю."
            steps={[
              'Проверяете работу — ИИ предлагает черновик.',
              'Корректируете и утверждаете — это сигнал для системы.',
              'При следующей похожей работе ваше решение используется как образец.',
              'Согласие между ИИ и вашими оценками растёт со временем.',
            ]}
          />
