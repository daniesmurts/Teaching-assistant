      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-6">
          <FeatureIntro
            ...
            description="Здесь хранятся все проверки и рецензии. Найдите нужную работу по имени студента, группе или курсу и откройте её, чтобы снова увидеть оценку, отзыв и полный разбор."
            steps={[
              'Используйте поиск по имени студента или группе, либо фильтры по курсу и статусу.',
