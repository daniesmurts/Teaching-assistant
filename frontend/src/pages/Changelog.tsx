          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-surface p-6 rounded-xl border border-border shadow-sm">
              ...
              <div className="text-sm text-ink-secondary space-y-2">
                ...
                <p><strong>Замечания с приоритетом и подсказкой «что сделать».</strong> Каждое замечание в ВКР-разборе получает уровень: <em>критично / существенно / незначительно</em> — критичные поднимаются в начало списка. Рядом — короткая метка действия: «к проверке» (ИИ нашёл расхождение) или «спросить автора» (ИИ не уверен — стоит уточнить). Под пунктом — одна фраза, что именно сделать: «пересчитать с учётом плотности 850, а не 920».</p>
                <p><strong>Независимый перерасчёт численных результатов.</strong> Для расчётных ВКР ИСПУМ запускает отдельную модель-рассуждателя, которая самостоятельно перепроверяет головные численные результаты — по тем же входным данным и формулам, что приведены в работе. Если расхождение существенное, в отчёте появится блок «Перерасчёт результатов»: значение из работы и значение ИИ-перепроверки бок о бок, плюс короткое объяснение, что именно не сошлось. Заодно проверяется применимость формул (например, Дитуса-Болтера при Re &gt; 10⁴) — выход за область применимости попадёт в замечания.</p>
              </div>
            </div>
          </div>
