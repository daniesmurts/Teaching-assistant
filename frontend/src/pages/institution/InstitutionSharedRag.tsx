  ...
  return (
    ...
    <div className="max-w-3xl mx-auto px-6 py-6">
      ...
      <p className="text-xs font-sans text-ink-tertiary mb-6 max-w-prose leading-relaxed">
        Когда включено, преподаватели кафедры могут поделиться своими утверждёнными проверками.
        Система будет опираться на оценки коллег по тому же предмету — кафедра вырабатывает общий стиль
      ...
      <div className="flex items-start gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="text-xs font-sans text-ink-secondary leading-relaxed">
            {enabled
              ? 'Утверждённые проверки преподавателей, поделившихся своими предметами, используются как примеры при оценке работ коллег по тому же предмету.'
