...
const KIND_UI: Record<MaterialKind, {
  ...
  assignment: {
    ...
    intro: 'Укажите тему и уровень сложности — ИИ подготовит набор практических заданий с условиями, развиваемыми умениями и подсказками для преподавателя.',
  ...
  case: {
    ...
    intro: 'Укажите тему — ИИ подготовит учебные кейсы: описание ситуации и вопросы для разбора, с указанием развиваемых умений.',
  ...
  project: {
    ...
    intro: 'Укажите тему — ИИ подготовит проектные задания: цель, ожидаемый результат и этапы работы, с критериями для преподавателя.',
