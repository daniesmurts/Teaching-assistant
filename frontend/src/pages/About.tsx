      ...
      <section className="py-24">
        <div className="max-w-[1000px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Principle
              number="01"
              title="Преподаватель решает. ИСПУМ помогает."
              body="Финальное слово — всегда за человеком. ИСПУМ готовит черновик оценки, разбор, рекомендации — но не выставляет отметку самостоятельно. Преподаватель проверяет, редактирует и утверждает. Если система ошибается — это видно, и это поправимо."
            />
            <Principle
              number="02"
            ...
            <Principle
              ...
              body="Загруженные работы не используются для тренировки публичных языковых моделей. Данные изолированы в вашем аккаунте — или, в случае института, в рамках вашей кафедры. Никто, кроме вас, к ним доступа не имеет."
            />
            <Principle
              number="04"
