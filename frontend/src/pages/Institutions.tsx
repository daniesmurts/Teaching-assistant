        ...
        <section className="py-24">
          <div className="max-w-[1000px] mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <FeatureBlock n="1" title="Общие рубрики кафедры">
              ...
              <FeatureBlock n="2" title="Рецензирование ВКР и дипломов">
              ...
              <FeatureBlock n="3" title="Массовое подключение преподавателей">
              ...
              <FeatureBlock n="4" title="Аналитика по студентам и группам">
              ...
              <FeatureBlock n="5" title="Журнал действий и админ-панель">
              ...
              <FeatureBlock n="6" title="Расчётные задачи и STEM">
                Физика, математика, инженерные дисциплины — ИИ пошагово пересчитывает решения, проверяет формулы, единицы измерения и размерности. Для технических факультетов.
              </FeatureBlock>
            </div>
          </div>
        </section>
            ...
            <div className="bg-surface border border-border rounded-xl p-8 grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3 text-sm text-ink-secondary">
                  <li className="flex gap-3"><span className="text-amber flex-shrink-0">✦</span><span>Разбивает работу на разделы и анализирует каждый</span></li>
                  <li className="flex gap-3"><span className="text-amber flex-shrink-0">✦</span><span>Оценивает структуру, аргументацию, источники, новизну</span></li>
                  <li className="flex gap-3"><span className="text-amber flex-shrink-0">✦</span><span>Формирует разбор по главам — что сильно, что слабо</span></li>
                  <li className="flex gap-3"><span className="text-amber flex-shrink-0">✦</span><span>Предлагает рекомендуемую оценку и комментарий</span></li>
                  <li className="flex gap-3"><span className="text-amber flex-shrink-0">✦</span><span>Готовит вопросы для защиты перед комиссией</span></li>
                </ul>
              </div>
              <div>
                <div className="text-xs font-semibold text-ink-tertiary uppercase tracking-wide mb-3">Что остаётся преподавателю</div>
                <ul className="space-y-3 text-sm text-ink-secondary">
                  <li className="flex gap-3"><span className="text-success flex-shrink-0">✓</span><span>Прочитать сжатый разбор за 10 минут</span></li>
                  <li className="flex gap-3"><span className="text-success flex-shrink-0">✓</span><span>Скорректировать оценку, если нужно</span></li>
                  <li className="flex gap-3"><span className="text-success flex-shrink-0">✓</span><span>Утвердить рецензию — она сохранится в журнале</span></li>
                  <li className="flex gap-3"><span className="text-success flex-shrink-0">✓</span><span>Использовать вопросы к защите без подготовки</span></li>
                </ul>
        ...
        <section className="bg-surface-warm py-20 border-y border-border">
          <div className="max-w-[1000px] mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-5">
              <TrustCard title="Хостинг в РФ" body="Яндекс.Облако, Москва. Без зарубежных серверов." />
              <TrustCard title="152-ФЗ" body="Соглашение об обработке ПДн под кафедру или факультет — по запросу." />
              <TrustCard title="Без VPN" body="Работает из любой университетской сети. Не блокируется." />
              <TrustCard title="Журнал действий" body="Все действия администраторов видны. Прозрачность для ИБ-службы." />
            </div>
          </div>
        </section>
...
function FeatureBlock({ n, title, children }: { n: string; title: string; children: React.ReactNode }) {
  return (
    <div className="bg-surface p-6 rounded-xl border border-border">
