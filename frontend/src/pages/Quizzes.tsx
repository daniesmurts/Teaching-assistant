          ...
          {!activeQuiz && (
            <>
              <FeatureIntro
                ...
                description="Введите тему — ИИ соберёт 5–20 вопросов с четырьмя вариантами ответа, опираясь на загруженные программу и лекционные материалы предмета. Каждый вопрос ссылается на конкретный фрагмент источника, чтобы вы могли быстро проверить корректность."
                steps={[
