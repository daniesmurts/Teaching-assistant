          ...
          <div className="max-w-[1000px] mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6 text-left">
              ...
              <p className="text-ink-secondary leading-relaxed">
                Когда на потоке учится 200 студентов, а работы проверяют три разных ассистента, сложно сохранить объективность. ИСПУМ (на тарифе "Институт") позволяет заведующему кафедрой создать <strong>единую рубрику</strong>, которая гарантирует, что каждый студент будет оценен по одним и тем же жестким критериям, независимо от того, кто именно из преподавателей проверяет работу.
              </p>
        ...
        <section className="py-20">
          <div className="max-w-[1000px] mx-auto px-6 flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="flex-1 space-y-6 text-left">
              ...
              <p className="text-ink-secondary leading-relaxed">
                При подготовке к государственным экзаменам ключевую роль играет количество написанных эссе. С ИСПУМ репетитор может задавать ученикам писать по 3-4 эссе в неделю, не сгорая на их проверке. ИСПУМ мгновенно находит стилистические ошибки и проверяет структуру по жёстким критериям ФИПИ.
              </p>
              <ul className="space-y-2 text-sm text-ink-secondary">
