  ...
  return (
    <div className="min-h-screen bg-bg text-ink selection:bg-amber-light selection:text-ink font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-[800px] mx-auto w-full px-6 py-16 md:py-24">
        <h1 className="font-display text-4xl font-bold mb-8 text-center">Этика ИИ и Образования</h1>
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-ink-secondary space-y-6">
          ...
          <p>
            GradeAssist спроектирован так, чтобы оценивать работы исключительно на основе объективных критериев рубрики, созданной преподавателем. Система не имеет доступа к демографическим данным студентов (если они не указаны в самом тексте), что помогает снизить уровень бессознательной предвзятости при оценке.
          </p>
