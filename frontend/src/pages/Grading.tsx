...
export default function Grading() {
  ...
  useEffect(() => {
    ...
    setResult({
      ...
      ai_verification_questions: resumeAssignment.ai_verification_questions ?? [],
      ai_revision_check:    resumeAssignment.ai_revision_check    ?? null,
      ai_question_responses: resumeAssignment.ai_question_responses ?? null,
      ...
      ai_calc_verification: resumeAssignment.ai_calc_verification ?? [],
      ai_citation_check:    resumeAssignment.ai_citation_check    ?? [],
        ...
        <div className="px-4 md:px-6 pt-5 flex-shrink-0">
          <div className="max-w-[960px] mx-auto">
            <FeatureIntro
              id="grading"
              videoSlug="grading"
              title="Проверка работ — ИСПУМ помогает с оценкой и обратной связью"
              description="Вставьте текст работы (или загрузите PDF, Word, скан), при желании выберите критерии — и платформа предложит оценку с разбором по пунктам, сильными сторонами и рекомендациями. Вы проверяете результат и подтверждаете его — финальное слово всегда за вами."
              steps={[
            ...
            <div className="flex-1 flex items-center justify-center p-8 text-center">
              <div>
                ...
                <p className="font-sans text-sm text-ink-secondary max-w-xs">
                  Вставьте работу студента слева и нажмите <strong>Проверить</strong>.
