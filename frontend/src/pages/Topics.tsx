        ...
        <div className="max-w-[820px] mx-auto px-4 md:px-6 py-6">
          {!result && (
            <FeatureIntro
              ...
              description="Опишите студента: уровень обучения, направление, интересы и место практики. ИСПУМ предложит конкретные, актуальные и выполнимые темы под нужный уровень — с обоснованием и объёмом работ. Для современности используется поиск в интернете."
              steps={[
