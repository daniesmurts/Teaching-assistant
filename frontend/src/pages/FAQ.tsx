    ...
    <div className="min-h-screen bg-bg text-ink selection:bg-amber-light selection:text-ink font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-[800px] mx-auto w-full px-6 py-16 md:py-24">
        ...
        <p className="text-ink-secondary text-center mb-16">
          Все, что вам нужно знать о работе с GradeAssist.
        </p>
        ...
        <div className="space-y-4">
          ...
          <FAQItem 
            ...
            answer="В настоящее время GradeAssist фокусируется на проверке логики, аргументации и стиля по заданным вами критериям. Встроенного детектора ИИ-текста нет, так как существующие на рынке детекторы часто дают ложноположительные результаты. Мы рекомендуем использовать GradeAssist для глубокого анализа структуры работы."
          />
          <FAQItem 
          ...
          <FAQItem 
            ...
            answer="Всегда только вы. GradeAssist работает как ваш цифровой ассистент: он предлагает детальный разбор работы и черновик оценки. Окончательный вердикт, правки и отправка результата студенту остаются исключительно за преподавателем."
          />
        </div>
      </main>
