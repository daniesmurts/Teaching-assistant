...
This resets the "one clean deploy" criterion below a second time — the docs-only deploy looked clean by every check that ran, but wasn't, and neither did the first attempted fix. Both worth being honest about before adding more moving parts.
