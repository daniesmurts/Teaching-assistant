...
- **Not yet run end-to-end against production** — written and syntax-verified locally (no Docker/VM access from this session), but the actual cutover deploy needs to be triggered by the operator.
